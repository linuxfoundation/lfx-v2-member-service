...
name: pr-conductor
description: >-
  Conduct an lfx-v2-member-service pull request to a clean state: reconcile the AI
...
- **The review method.** To judge whether a fix is real or a rebuttal is
  ...
  unverifiable cross-repo claim is not a substantiated rebuttal, but it is not
  a substantiated blocker either.
